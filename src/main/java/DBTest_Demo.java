...
public class DBTest_Demo {
    // Level 3: Client (Laptop) → Server EC2 (Different Network, No SSL)
    private static final String HOST = "18.216.27.232";  // Server public IP
    ...
    public static void main(String[] args) {
        System.out.println("Example for MYSQL DB connection via Java (Level 3: Different Network, No SSL)");
        int offset = 0;
        ...
        try (Connection conn = DriverManager.getConnection(JDBC_URL, USER, PASS);
            ...
            System.out.println("MYSQL Connection Successful (Remote Level 3)");
        } catch (Exception e) {
